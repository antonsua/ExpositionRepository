...
//used for pointers to color
#define COLOREXP_P(color) color->r, color->g, color->b, color->a
//used for pointers to pointer to color
#define COLOREXP_PP(color) (*color)->r, (*color)->g, (*color)->b, (*color)->a
